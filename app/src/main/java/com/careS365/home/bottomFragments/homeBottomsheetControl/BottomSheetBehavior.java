 ...
 * bottom sheet.
 */
public class BottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> implements ICustomBottomSheetBehavior<V> {
    ...
    public BottomSheetBehavior(Context context, AttributeSet attrs) {
        ...
        setExpandedOffset(a.getInt(com.google.android.material.R.styleable.BottomSheetBehavior_Layout_behavior_expandedOffset, 0));
        a.recycle();
